...
namespace FactoryModule
{
    public partial class AddSupplier : Form
    {
        ...
        private void DataGrid()
        {
            ...
            cmd.CommandText = "SELECT SupplierID as 'ID', SupplierName as 'Name', SupplierContactPerson as 'Contact Person', SupplierPhone as 'Contact Number', SupplierVatRegNo as 'Vat Reg No', SupplierEmail as 'Email', SupplierAddress as 'Address' FROM FactorySupplier";
            cmd.ExecuteNonQuery();
        ...
        private void btnAddSupplier_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string query11 = "INSERT INTO FactorySupplier VALUES('01', '" + supplier_name + "', '" + supplier_contact_person + "', '" + supplier_phone + "', '" + supplier_vat_reg_no + "', '" + supplier_email + "','" + supplier_address + "')";
        ...
        {
            textBoxSupplierID.Text = textBoxSupplierName.Text = textBoxContactPerson.Text = textBoxSupplierPhone.Text = textBoxVatRegNo.Text = textBoxSupplierEmail.Text = textBoxSupplierAddress.Text = "";
        }
        private int Already_Supplier_Name(string Supplier_Name)
        {
            int exist = 0;
            string query = "SELECT SupplierID FROM FactorySupplier WHERE SupplierName='" + Supplier_Name + "'";
        ...
        private void buttonSupplierUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string querys = "UPDATE FactorySupplier SET SupplierName = '" + textBoxSupplierName.Text + "', SupplierContactPerson = '" + textBoxContactPerson.Text + "', SupplierPhone = '" + textBoxSupplierPhone.Text + "', SupplierVatRegNo = '" + textBoxVatRegNo.Text + "', SupplierEmail = '" + textBoxSupplierEmail.Text + "', SupplierAddress = '" + textBoxSupplierAddress.Text + "'  WHERE SupplierID = '" + textBoxSupplierID.Text + "'";
